...
export class TopicController {
  ...
  @Post(':id/follow')
  @UseGuards(JwtGuard)
  follow(@Param('id') id: number, @Req() request: Request) {
    return this.topicService.followTopic(id, request.user as User);
  }

  @Post(':id/unfollow')
  @UseGuards(JwtGuard)
  unfollow(@Param('id') id: number, @Req() request: Request) {
    return this.topicService.unfollowTopic(id, request.user as User);
  }
